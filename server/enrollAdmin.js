...
const { FileSystemWallet, X509WalletMixin, Gateway, IdentityProviderRegistry } = require('fabric-network');
const fs = require('fs');
...
async function main(){
    try {
        ...
        const caInfo = ccp.certificateAuthorities['ca.medplace1.example.com'];
        console.log(caInfo);
